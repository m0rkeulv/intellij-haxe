...
public class HaxeResolveChecks {
  ...
  /**
   * Resolves through the file's imports, then the same package, then as a
   * qualified name. When several imports match, enum-value constructors are
   * disambiguated by argument list and type positions by class name.
   */
  @Nullable
  static List<? extends PsiElement> checkImports(@NotNull HaxeReference reference, @Nullable HaxeFileModel fileModel, boolean isType) {
    ...
    if (fileModel != null) {
      ...
      if (isType) {
        matchesInImport = matchesInImport.stream().filter(HaxeResolveChecks::removeNonTypeComponents).toList().reversed();
      }
      if (!matchesInImport.isEmpty()) {
        ...
        return normalizeClassResults(matchesInImport);
      }
    ...
    return checkQualifiedName(reference);
  }

    static List<? extends PsiElement> checkIsMetadataSpecial(@NotNull HaxeReference reference) {
   ...
   */
    static List<? extends PsiElement> checkIsFakeReference(@NotNull HaxeReference reference, String referenceText) {
      return switch (referenceText) {
          ...
          case "__js__" ->  createSyntheticForSyntax(referenceText, "js.Syntax.code", reference);
          case "__php__" ->  createSyntheticForSyntax(referenceText, "php.Syntax.code", reference);
          case "__python__" ->  createSyntheticForSyntax(referenceText, "python.Syntax.code", reference);
          case "__cpp__" ->  createSyntheticForSyntax(referenceText, "cpp.Syntax.code", reference);
          case "__cs__" ->  createSyntheticForSyntax(referenceText, "cs.Syntax.code", reference);
          case "__java__" ->  createSyntheticForSyntax(referenceText, "java.Syntax.code", reference);
          case "__lua__" ->  createSyntheticForSyntax(referenceText, "lua.Syntax.code", reference);
          case null, default -> null;
        };

    }

  private static boolean removeNonTypeComponents(PsiElement element) {
  ...
  static List<? extends PsiElement> checkIsLocalModule(@NotNull HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkIfNamedSwitchValue(@NotNull HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkElementUsage(@NotNull PsiElement reference) {
  ...
  private static ResultHolder findParentAssignType(@NotNull PsiElement reference, boolean isValueExpression) {
    ...
    // no point walking all the way up to HaxeFile,  once we reach a type/module definition it should be safe to stop.
    if (parent instanceof HaxeMethodDeclaration || parent instanceof HaxeFieldDeclaration ){
      return null;
    }
  ...
  private static HaxeComponentName searchInEnumObjectAndArrayExtractors(PsiElement psiElement) {
  ...
  private static HaxeModel getModelForElement(PsiElement psiElement) {
  ...
  private static HaxeModel getGetModelFromResultHolder(ResultHolder result ) {
  ...
  static List<? extends PsiElement> checkSwitchOnEnum(HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkEnumMemberHints(HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkGlobalAlias(HaxeReference reference, String referenceText) {
    if ("trace".equals(referenceText)) {
      return getOrCreateSyntheticForTrace(reference);
    }
    return null;
  }

  @Nullable
  static List<PsiElement> searchInSameFile(@NotNull HaxeReference reference, HaxeFileModel fileModel, boolean isType) {
    if(fileModel != null) {
  ...
  static List<? extends PsiElement> checkMacroIdentifier(HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkMemberReference(HaxeReference reference) {
  ...
  private static List<? extends PsiElement> removeStaticMembersFromElementList(List<? extends PsiElement> superElements) {
    return superElements.stream()
            .filter(psiElement -> !(psiElement.getParent() instanceof HaxePsiField field && field.isStatic()))
            .toList();
  }

  static List<? extends PsiElement> checkIsTypeParameter(HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkEnumExtractor(HaxeReference reference) {
  ...
  static @Nullable List<@NotNull PsiElement> checkReferenceInExtractorMatchExpression(HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkCaptureVarReference(HaxeReference reference) {
   ...
   */
  private static HaxeReferenceExpression getReferenceFromExtractorMatchExpression(HaxeExtractorMatchExpression expression) {
  ...
  static List<? extends PsiElement> checkCaptureVar(HaxeReference reference) {
    HaxeExtractorMatchExpression matchExpression = PsiTreeUtil.getParentOfType(reference, HaxeExtractorMatchExpression.class);
    if (matchExpression!= null) {
   ...
   */
  static List<? extends PsiElement> checkIsSwitchVar(HaxeReference reference) {
  ...
  private static @Nullable List<? extends PsiElement> searchCaseBlockForReference(HaxeReference reference, PsiElement switchCase) {
  ...
  /** ide-facing entry (capture-variable inlay hints): answers via the extractor check, so it lives here. */
  ...
  @Nullable
  private static List<PsiElement> checkIfDefaultValueInMatchExpression(HaxeReference reference, HaxeSwitchCaseExpr switchCaseExpr) {
    //TODO/NOTE:
  ...
  private static int findExtractorIndex(PsiElement[] children, HaxeExpression expression) {
    for (int i = 0; i < children.length; i++) {
  ...
  static List<? extends PsiElement> checkIsForwardedName(HaxeReference reference) {
    List<? extends PsiElement> result = null;
  ...
  static List<? extends PsiElement> checkByTreeWalk(HaxeReference reference) {
    return checkByTreeWalk(reference, (PsiElement)null);
  }


  static List<? extends PsiElement> checkByTreeWalk(HaxeReference scope, String name) {
    final List<PsiElement> result = new ArrayList<>();
  ...
  static List<? extends PsiElement> checkIsAccessor(HaxeReference reference) {
  ...
  @Nullable
  static List<? extends PsiElement> checkIsChain(@NotNull HaxeReference reference, String referenceText) {
    if (reference instanceof HaxeReferenceExpression referenceExpression) {
  ...
  @Nullable
  static List<? extends PsiElement> checkIsModuleName(@NotNull HaxeReference reference, String referenceText) {
  ...
  @Nullable
  static List<? extends PsiElement> checkIsClassName(@NotNull HaxeReference reference, String referenceText) {
    if(reference instanceof HaxeEnumExtractedValueReference) return null;
    if(textCanBeRefOfClassOrModule(reference.getText())) {
  ...
  static boolean isQualifiedNameReferenceStructure(HaxeReference reference) {
    int refCount = 0;
  ...
  @Nullable
  static List<? extends PsiElement> checkIsSuperExpression(HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkIsNewExpression(@NotNull HaxeReference reference) {
  ...
  @Nullable
  static List<? extends PsiElement> checkIsType(HaxeReference reference) {
    if (reference instanceof HaxeReferenceExpression referenceExpression) {
        ...
        final HaxeClass haxeClassInType = HaxeResolveUtil.tryResolveClassByQName(type);
          ...
          if (children.length > 1) {
            if (children[0] instanceof HaxeReference child) {
              List<? extends PsiElement> resolve = HaxeResolver.getInstance(child.getProject()).resolve(child, false);
              if (!resolve.isEmpty()) {
  ...
  @Nullable
  static List<? extends PsiElement> checkIsAlias(HaxeReference reference) {
  ...
  static List<? extends PsiElement> checkIsFullyQualifiedStatement(@NotNull HaxeReference reference) {
    if (reference instanceof HaxeReferenceExpression) {
  ...
  private static List<PsiElement> normalizeClassResults(List<PsiElement> elements) {
    return elements.stream().map(HaxeResolveChecks::normalizeClassResult).toList();
  }

  static void LogResolution(HaxeReference ref, String tailmsg) {
  ...
  static final RecursionGuard<PsiElement> extensionsFromMetaGuard = RecursionManager.createGuard("extensionsFromMetaGuard");
  static final RecursionGuard<PsiElement> extensionsMethodGuard = RecursionManager.createGuard("extensionsMethodGuard");
   ...
   */
  @Nullable
  private static List<? extends PsiElement> resolveChain(HaxeReference lefthandExpression, HaxeReference reference) {
    ...
    ResultHolder result = HaxeEvaluationTaint.computeOrTaint(extensionsMethodGuard, lefthandExpression, true, () -> {
      return HaxeExpressionEvaluator.evaluate(lefthandExpression, context, null).result;
    });
    if(result== null || result.isUnknown()) {
      // unknown receiver type makes this whole resolve attempt unreliable;
      // the taint keeps its outcome out of every cache
    ...
    if (haxeClass != null && !result.isUnknown()) {
      ...
      if (haxeClass != null) {
        ...
        HaxeComponentName match = HaxeEvaluationTaint.computeOrTaint(extensionsFromMetaGuard, lefthandExpression, true, () -> {
          int size = classModel.getUsingMetaReferences().size();
          List<HaxeMethodModel> meta = classModel.getExtensionMethodsFromMeta();
          if (size != meta.size()) {
            // some meta references did not resolve - mark the attempt
            // unreliable so no cache freezes it
            HaxeEvaluationTaint.taint();
          }
  ...
  private static HaxeClass useDefaultIfTypeParameter(HaxeReference reference, HaxeClass haxeClass) {
  ...
  private static PsiElement resolveQualifiedReference(HaxeReference reference) {
   ...
   */
  @Nullable
  private static HaxeComponentName tryResolveHelperClass(HaxeReference leftReference,HaxeReference identifierRef,  String helperName) {
  ...
  static String traceMsg(String msg) {
  ...
  private static @NonNull List<PsiElement> createSyntheticForSyntax(String name, String qname, HaxeReference reference) {
    return List.of(HaxeSyntheticPsiUtil.createSyntheticForTargetSpecificSyntax(name, qname, reference));
  }

  private static @NonNull List<PsiElement> getOrCreateSyntheticForTrace(HaxeReference reference) {
