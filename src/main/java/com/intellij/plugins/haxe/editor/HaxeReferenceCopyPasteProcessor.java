...
public class HaxeReferenceCopyPasteProcessor extends CopyPastePostProcessor<HaxeTextBlockTransferableData>  {
  ...
  @Override
  public void processTransferableData(Project project, Editor editor, RangeMarker marker, int caretOffset, Ref<? super Boolean> indented, List<? extends HaxeTextBlockTransferableData> values) {
