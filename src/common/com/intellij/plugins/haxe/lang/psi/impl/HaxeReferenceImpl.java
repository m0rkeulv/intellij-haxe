        ...
        for (HaxeExpression expression : haxeExpressionList) {
          ...
          if (sameClass || implementOrExtendSameClass || SameFunctionDefinition) {
            ...
            if (haxeReference != null) {
              ...
              ////TODO Testing  All working code had this commented out
              //if (haxeClassResolveResultHaxeClass instanceof HaxeClassDeclaration) {
              //  SpecificHaxeClassReference reference = haxeClassResolveResult.getSpecificClassReference(haxeReference, null);
              //  ResultHolder holder = reference.createHolder();
              //  if(typeCanBeWrapped(holder)) {
              //    haxeClassResolveResultHaxeClass  = wrapType(holder, haxeReference.getContext(), reference.isEnumType()).getHaxeClass();
              //  }
              //}
