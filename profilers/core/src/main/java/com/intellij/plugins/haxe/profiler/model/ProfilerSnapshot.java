 ...
 * every recorded stack sample in capture order, and the target's custom
 * events. Deliberately dumber than any one source format — aggregation
 * (identical-stack merging), inversion and filtering are viewer concerns and
 * happen downstream; translators fill this losslessly.
 *
