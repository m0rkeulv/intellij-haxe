/**
 * Native (VM-raised) exception fixture: a genuine null access, which HashLink's
 ...
 * the hl_throw trap (the "native" filter) can stop here.
 *
...
class NativeError {
	public static function main():Void {
		Sys.println("native-error-start");
