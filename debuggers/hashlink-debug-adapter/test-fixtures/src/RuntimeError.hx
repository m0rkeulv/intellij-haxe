/**
 * Runtime (VM-raised) exception fixture: a genuine null access, which HashLink's
 * C runtime raises through hl_null_access -> hl_throw WITHOUT executing a
 * bytecode OThrow. The OThrow-based exception breakpoints never see it; only
 * the hl_throw trap (the "runtime" filter) can stop here.
 *
...
class RuntimeError {
	public static function main():Void {
		Sys.println("runtime-error-start");
